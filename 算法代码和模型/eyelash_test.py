...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='config/EyelashNet.toml')
    parser.add_argument('--checkpoint', type=str, default='checkpoints/EyelashNet/best_model.pth',
                        help="path of checkpoint")
    parser.add_argument('--image-dir', type=str, default='./changshi', help="input image dir")
    parser.add_argument('--trimap-dir', type=str, default='', help="input trimap dir")
    parser.add_argument('--output', type=str, default='./shuchu', help="output dir")
